...
//CODING CHALLENGE AUG 6 2019
//func pizzaToppings (eatPizza : Int) {
//    print ("there are \(eatPizza) toppings to get on the pizza")
//}
//pizzaToppings(eatPizza: 5)


//func pizzaFriends (pizzaSlices : Int) {
//    print ("we will buy a large \(pizzaSlices) sliced pizza to split with us 5 and we will also have 2 more slices left over")
//
//}
//pizzaFriends(pizzaSlices : 12)
//
